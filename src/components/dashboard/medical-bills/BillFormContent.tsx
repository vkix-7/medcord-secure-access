...
interface BillFormContentProps {
  recordId?: string;
  onSuccess: () => void;
  records: Array<{ id: string; title: string }>;
  setRecords: React.Dispatch<React.SetStateAction<Array<{ id: string; title: string }>>>;
}

export default function BillFormContent({ recordId, onSuccess, records, setRecords }: BillFormContentProps) {
